...
if(isset($_POST["submit"])){
        ...
        $insert = $DBcon->query("INSERT into chattogramHotelRent (username,name,chkin,chkout,noAdults,noChild,room,created) VALUES ('$username','$name','$in','$out','$adults','$child','$room', '$dataTime')");
        if($insert){
