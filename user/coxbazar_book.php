...
$get=$DBcon->query("SELECT name FROM coxbazarHotel");
if(isset($_POST["submit"])){
        ...
        $insert = $DBcon->query("INSERT into coxbazarHotelRent (username,name,chkin,chkout,noAdults,noChild,room,created) VALUES ('$username','$name','$in','$out','$adults','$child','$room', '$dataTime')");
        if($insert){
...
?>
    ...
    <body>
        ...
        <div class="container" style="margin-top:150px;text-align:center;font-family:Verdana, Geneva, sans-serif;font-size:35px;">
            <h1>Book your Room  - Cox Bazar Area</h1>
            <?php
                            if (isset($msg)) {
                                echo $msg;
                            }
