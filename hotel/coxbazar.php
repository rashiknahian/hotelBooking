...
if(isset($_POST["submit"])){
        ...
        $insert = $DBcon->query("INSERT into coxbazarHotel (username,name,email,phone,address,rent,room,created) VALUES ('$username','$name','$email','$phone','$address','$rent','$room', '$dataTime')");
        if($insert){
...
?>
    ...
    <body>
        ...
        <div class="container" style="margin-top:150px;text-align:center;font-family:Verdana, Geneva, sans-serif;font-size:35px;">
            <h1>Register your Hotel - Coxbazar Area</h1>
            <?php
                            if (isset($msg)) {
                                echo $msg;
                            }
